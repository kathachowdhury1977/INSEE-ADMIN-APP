...
function EditAccountForm(props) {
    ...
    const { ownerSoldToShipToList, primaryMobileNumber, inseeRefId } = location.state;
    ...
    useEffect(() => {
        ...
        fetch(API_URL_USER + `mds/soldTo/getUsercontactDetails?soldToNumber=` + accountName + `&userId=` + primaryMobileNumber, requestOptions)
            .then((res) => res.json())
            .then((result) => {
    ...
    const handleSubmit1 = () => {
        ...
        dispatch(eventActions.updateContactList(productData, primaryMobileNumber, upload));
    ...
    console.log("updateData+++++dsfsdfd", inputList);
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div className="inputBox">
                                                                    ...
                                                                    <input className="input" defaultValue={updateData && updateData.primaryMobileNumber} disabled type="text" name={"mobile"} onChange={event => setMobile(event.target.value)} className="form-control" placeholder="Enter User Name" />
                                                            ...
                                                            {(country === "VN" && relation === "Owner" || updateData.countryCode === "VN" && updateData.relation === "Owner" || country === "LK" && relation === "Owner" || updateData.countryCode === "LK" && updateData.relation === "Owner") || (country === "VN" && relation === "Staff" || updateData.countryCode === "VN" && updateData.relation === "Staff" || country === "LK" && relation === "Staff" || updateData.countryCode === "LK" && updateData.relation === "Staff") ?
