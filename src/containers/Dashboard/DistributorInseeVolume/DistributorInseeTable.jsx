...
import EditDistributorInseePopup from "../../../components/ModalPopup/EditDistributorInseePopup";
...
export default function DistributorInseeTable(props) {
    ...
    const handleDistributorInsee = (event,id,soldTo,division,productBrand,jan,feb,mar,apr,may,june,july,august,sep,oct,nov,dec,year,type) => {
        setGroupDetail({ 'id':id, 'soldTo': soldTo, 'division':division, 'productBrand':productBrand, 'jan':jan,'feb':feb,'mar':mar,'apr':apr,
        'may':may, 'june':june,'july':july,'august':august,'sep':sep,'oct':oct,'nov':nov,'dec':dec,'year':year,'type':type});
        setPopupopen(true);
    } 
    ...
    return (
        <div className={classes.root}>
                                            ...
                                            return (
                                                ...
                                                >
                                                   ...
                                                   <span className="product_group-edit"  
                                                    onClick={(event) => handleDistributorInsee(event, row.id,
                                                      row.soldTo,
                                                      row.division,row.productBrand,row.jan,row.feb,row.mar,row.apr,row.may,row.june,
                                                      row.july,row.august,row.sep,row.oct,row.nov,row.dec, row.year,row.type
            ...
            <div>
            <EditDistributorInseePopup groupDetail={groupDetail} popupopen={popupopen} setOpen={setPopupopen} />
            </div>
