...
export default function CustomerIdListPopup(props) {
    const [open, setOpen1] = React.useState(false);
    const dispatch = useDispatch();
    const myList = props.customerIds;
    console.log("mySoldNumberList", myList);



    useEffect(() => {
        if (props.customerpop) {
            props.setOpen(true);
        }
    ...
    return (
        <div className="guideline_popup">
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={props.customerpop}>
