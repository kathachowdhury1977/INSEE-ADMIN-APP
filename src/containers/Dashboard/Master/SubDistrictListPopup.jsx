...
export default function SubDistrictListPopup(props) {
    const [open, setOpen1] = React.useState(false);
    const dispatch = useDispatch();
    const myList = props.subdistrictId;
    console.log("mySoldNumberList", myList);



    useEffect(() => {
        if (props.subdistrictpop) {
            props.setOpen(true);
        }
    ...
    return (
        <div className="guideline_popup">
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={props.subdistrictpop}>
