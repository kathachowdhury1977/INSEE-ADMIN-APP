...
export default function DistrictListPopup(props) {
    const [open, setOpen1] = React.useState(false);
    const dispatch = useDispatch();
    const myList = props.districtId;
    console.log("mySoldNumberList", myList);



    useEffect(() => {
        if (props.districtpop) {
            props.setOpen(true);
        }
    ...
    return (
        <div className="guideline_popup">
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={props.districtpop}>
