...
export default function ProvinceListPopup(props) {
    const [open, setOpen1] = React.useState(false);
    const dispatch = useDispatch();
    const myList = props.provinceId;
    console.log("mySoldNumberList", myList);



    useEffect(() => {
        if (props.provincepop) {
            props.setOpen(true);
        }
    ...
    return (
        <div className="guideline_popup">
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={props.provincepop}>
