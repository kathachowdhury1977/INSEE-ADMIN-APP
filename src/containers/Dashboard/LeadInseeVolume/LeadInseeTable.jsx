...
import EditleadInseePopup from "../../../components/ModalPopup/EditleadInseePopup";
...
export default function LeadInseeTable(props) {
    ...
    const handleLeadInsee = (event,soldTo,division,productBrand,jan,feb,mar,apr,may,june,july,august,sep,oct,nov,dec, year,type,id) => {
    ...
    return (
        <div className={classes.root}>
                                        ...
                                        .map((row, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="right"> <span className="product_group-edit"  
                                                    onClick={(event) => handleLeadInsee(event, 
                                                      row.soldTo,
            ...
            <div>
            <EditleadInseePopup groupDetail={groupDetail} popupopen={popupopen} setOpen={setPopupopen} />
            </div>
