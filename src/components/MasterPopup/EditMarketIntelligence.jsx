...
export default function EditMarketIntelligence(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.marketIntelligence;
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div class="form-group">
                                <label for="customer_group">Market Intelligence Name</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
