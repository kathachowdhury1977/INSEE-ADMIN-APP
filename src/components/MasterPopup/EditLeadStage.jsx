...
export default function EditLeadStage(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.leadStage;
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    defaultValue={myActionDetails.leadStageId}
                                />
                            </div>
                            <div class="form-group">
                                <label for="customer_group">Lead Stage Name</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.leadStage} />
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.score} />
                            </div>
                        </form>
