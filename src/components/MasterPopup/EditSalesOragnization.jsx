...
export default function EditSalesOragnization(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.salesOrg;
                    ...
                    <Typography gutterBottom>
                        <form>
                            ...
                            <div class="form-group">
                                <label for="customer_group">Sales Organization Key</label>
                                <input type="text"
                                    class="form-control"
