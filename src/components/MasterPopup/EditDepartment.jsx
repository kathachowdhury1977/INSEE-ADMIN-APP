...
export default function EditDepartment(props) {
    ...
    const myActionDetails = props.departmentL;
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div class="form-group">
                                <label for="customer_group">Department Name</label>
                                <input type="text"
                                    class="form-control"
                            ...
                            <div class="form-group">
                                <label for="customer_group">Department Discription</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.desc} />
                            </div>
                        </form>
