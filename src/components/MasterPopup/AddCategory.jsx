...
export default function AddCategory(props) {
    ...
    const addcategoryReducer = useSelector((state) => state.addcategorymaster);
    ...
    const handleSubmit = () => {
        dispatch(eventActions.addCategory(country,name));
        setOpen(false);
      } 

      useEffect(() => {
        if (addcategoryReducer && !addcategoryReducer.loading &&
            (addcategoryReducer.addcategory)) {
    ...
    useEffect(() => {
        return () => {
            dispatch(eventActions.addCategory())
        }
    }, [])
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div className="form-group">
                                <label for="customer_group"> Category Name</label>
