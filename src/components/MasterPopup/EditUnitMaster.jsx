...
export default function EditUnitMaster(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.unitMaster;
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div class="form-group">
                                <label for="customer_group">Unit Master Type</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="category"
                                    defaultValue={myActionDetails.type}
                                />
                            </div>
                            <div class="form-group">
                                <label for="customer_group">Unit Master Name</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
