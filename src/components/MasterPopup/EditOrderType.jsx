...
export default function EditOrderType(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.orderType;
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div class="form-group">
                                <label for="customer_group">Order name</label>
                                <input type="text"
                                    class="form-control"
                            ...
                            <div class="form-group">
                                <label for="customer_group">Order Type</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
