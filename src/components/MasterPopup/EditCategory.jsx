...
export default function EditCategory(props) {
    ...
    const categoryReducer = useSelector((state) => state.updatecategorymaster);
    ...
    const handleSubmit = () => {
        dispatch(eventActions.updateCategory(
            {
    ...
    useEffect(() => {
        if (categoryReducer && !categoryReducer.loading &&
            (categoryReducer.updatecategory)) {
