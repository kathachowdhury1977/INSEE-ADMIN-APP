...
export default function EditTransportorZone(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.zone;
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    defaultValue={myActionDetails.transporterZone}
                                />
                            </div>
                            <div class="form-group">
                                <label for="customer_group">District Code</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.disctrictCode} />
                            </div>
                            ...
                            <div class="form-group">
                                <label for="customer_group">Province Code</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.provinceCode} />
                            </div>
                            ...
                            <div class="form-group">
                                <label for="customer_group">Country Code</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.countryCode} />
                            </div>
