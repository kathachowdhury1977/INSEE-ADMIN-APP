...
export default function EditSalesDistrict(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.salesDistrict;
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div class="form-group">
                                <label for="customer_group"> Sales District Name</label>
                                <input type="text"
                                    class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.satus} />
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.code} />
                            </div>
                        </form>
