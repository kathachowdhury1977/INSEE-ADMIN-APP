...
export default function EditDistributionArea(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.distributionArea;
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    defaultValue={myActionDetails.distributionKey}
                                />
                            </div>
                            <div class="form-group">
                                <label for="customer_group">Distribution Name</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.distributionValue}
                                     />
                            </div>
                        </form>
