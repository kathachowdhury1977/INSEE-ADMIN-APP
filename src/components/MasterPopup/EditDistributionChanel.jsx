...
export default function EditDistributionChanel(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.distributionChanel;
                ...
                <DialogContent dividers>
                    <Typography gutterBottom>
                        <form>
                            ...
                            <div class="form-group">
                                <label for="customer_group">Distribution Channel Name</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
