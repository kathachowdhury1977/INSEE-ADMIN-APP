...
export default function EditPriceBook(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.priceBook;
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div class="form-group">
                                <label for="customer_group">Price Book Name</label>
                                <input type="text"
                                    class="form-control"
                                    placeholder="category"
                                    defaultValue={myActionDetails.priceBookKey}
                                />
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control"
                                    placeholder="value"
                                    defaultValue={myActionDetails.priceBookValue} />
                            </div>
                        </form>
