...
export default function EditActionStatus(props) {
    const [open, setOpen] = React.useState(false);
    const dispatch = useDispatch();
    const myActionDetails = props.actionStatus;
    const [keyValue, setKeyValue] = React.useState("");
    const [value, setValue] = React.useState("");
    
    const UpdateStatus = useSelector((state) => state.updateactionstatus);
    console.log("myActionDetails", myActionDetails.key);
    ...
    const handleSubmit = () => {
        let data = {
            "key": keyValue || myActionDetails.key,
            "value" : value || myActionDetails.value
        }

        dispatch(eventActions.UpdateActionStatus(data));
        setKeyValue("");
        setValue("");
        props.setOpen(false);
    }
    ...
    useEffect(() => {
        return () => {
            dispatch(eventActions.UpdateActionStatus())
        }
    }, [])
