...
export default function AddCaseType(props) {
    const dispatch = useDispatch();
    const [name, setName] = React.useState("");
    const [status, setStatus] = React.useState("Active");
    const [open, setOpen] = React.useState(false);
    const [country, setCountry] = React.useState("TH");
    const addcasetypeReducer = useSelector((state) => state.addcasetype);
    ...
    const handleSubmit = () => {
        ...
        dispatch(eventActions.addCaseType(userName.countryCode,data));
        setOpen(false);
      } 

      useEffect(() => {
        if (addcasetypeReducer && !addcasetypeReducer.loading &&
            (addcasetypeReducer.addcasetype)) {
    ...
    useEffect(() => {
        return () => {
            dispatch(eventActions.addCaseType())
        }
    }, [])
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div className="form-group">
                                <label for="customer_group"> Case Type</label>
