...
export default function EditCategoriesPopup(props) {
    ...
    useEffect(() => {
        props.categoryId && dispatch(eventActions.conwoodAutofillCategory(props.categoryId));
    ...
    console.log("ConwoodAutoList+++++", ConwoodAutoList && ConwoodAutoList);
     ...
     console.log("mytodayList",mySubList);
    ...
    const handleSubmit = () => {
        setInputList(mySubList)
        console.log('77777', inputList);
        console.log('8888', mySubList)
        let data = {
            ...
            "status": "string",
            "subCategoryId": 0,
            "subCategoryList": inputList ? inputList : !!mySubList,
