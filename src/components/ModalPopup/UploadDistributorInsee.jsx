...
export default function UploadDistributorInsee(props) {
    ...
    const handleSubmit = () => {
         dispatch(eventActions.uploadInseeVolume( year, upload));
             setOpen(false);
    };

    useEffect(() => {
        if (!!uploasDistributorInsee && !!uploasDistributorInsee.uploadinseevolume && uploasDistributorInsee.uploadinseevolume !== undefined) {
        ...
        <div className="guideline_popup">
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                    Upload Distributor Insee Volume
                </DialogTitle>
