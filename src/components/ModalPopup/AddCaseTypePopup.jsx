...
export default function AddCaseTypePopup(props) {
    ...
    const handleSubmit = () => {
        ...
        dispatch(eventActions.addCaseType(country, data));
        setOpen(false);
                    ...
                    <Typography gutterBottom>
                        <form>
                            ...
                            <div className="form-group">
                                <label for="group_code"> Case Type code</label>
                                <input type="text" onChange={event => setCase(event.target.value)} class="form-control" placeholder="enter case type" />
                            </div>
                            <div className="form-group">
