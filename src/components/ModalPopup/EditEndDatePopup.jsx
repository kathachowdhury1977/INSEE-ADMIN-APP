...
export default function EditEndDatePopup(props) {
    ...
    const handleSubmit = () => {
        dispatch(eventActions.editConwoodList(myCategoryId, enddate, startdate));
        setOpen(false);
    }
    ...
    useEffect(() => {
        if (editcategory && editcategory.editconwoodlist !== undefined) {
            ...
            toast.success('Modified start and end date successfully', {
                position: "top-right",
                autoClose: 4000,
                        ...
                        <form>
                            <div class="form-group">
                              <label for="customer_group">Start Date</label>
                                <input type="date" placeholder={mysdate} onChange={event => setStartDate(event.target.value)}/>
                            </div>
                            <div class="form-group">
