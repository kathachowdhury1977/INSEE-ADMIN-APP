...
export default function AddAreaTypePopup(props) {
    ...
    const addareatypeReducer = useSelector((state) => state.addareatypemaster);
    ...
    useEffect(() => {
        if (addareatypeReducer && !addareatypeReducer.loading &&
            (addareatypeReducer.addareatype)) {
            ...
            dispatch(eventActions.resetAddAreaTypeReducer());
    ...
    const handleSubmit = () => {
        ...
        dispatch(eventActions.addAreaType(country,data));
        setOpen(false);
      } 
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div className="form-group">
                                <label for="customer_group">Area Type Name</label>
                                <input type="text"  class="form-control" onChange={event => setName(event.target.value)} placeholder="enter area type" />
                            </div>
                            <div className="form-group">
