...
export default function UploadLeadsInseeVolume(props) {
    ...
    const handleSubmit = () => {
          ...
          dispatch(eventActions.uploadLeadInseeVolume(year, upload));
            setOpen(false);
    ...
    useEffect(() => {
        if (!!uploasLeadInseeVolume && !!uploasLeadInseeVolume.uploadleadinseevolume && uploasLeadInseeVolume.uploadleadinseevolume !== undefined) {
