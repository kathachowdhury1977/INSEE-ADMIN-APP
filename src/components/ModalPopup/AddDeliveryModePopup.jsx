...
export default function AddDeliveryModePopup(props) {
    ...
    const adddeliverymodeReducer = useSelector((state) => state.adddeliverymodemaster);
    ...
    useEffect(() => {
        if (adddeliverymodeReducer && !adddeliverymodeReducer.loading &&
            (adddeliverymodeReducer.adddeliverymode)) {
            ...
            dispatch(eventActions.resetAddDeliveryModeReducer());
            dispatch(eventActions.getDeliveryMode(userName.countryCode));
        }
    }, [adddeliverymodeReducer]);
    ...
    const handleSubmit = () => {
        ...
        dispatch(eventActions.addDeliveryMode(country,data));
        setOpen(false);
      } 
                    ...
                    <Typography gutterBottom>
                        <form>
                            <div className="form-group">
                                <label for="group_code">Delivery Mode Name</label>
                                <input type="text" class="form-control" onChange={event => setName(event.target.value)} placeholder="enter delivery mode name" />
                            </div>
                            <div className="form-group">
