...
export default function AddTypeProjectProceedPopup(props) {
                    ...
                    <Typography gutterBottom>
                        <form>
                            ...
                            <div className="form-group">
                                <label for="group_code"> Type Proceed Name</label>
                                <input type="text" class="form-control" placeholder="enter shipping nane" />
                            </div>
                            <div className="form-group">
                                <label for="group_code">Type Proceed Status</label>
                                <select name="" id="">
